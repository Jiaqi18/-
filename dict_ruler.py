...
class DictClassifier:
    def __init__(self):
        self.__root_filepath = "data/zidian/"

        jieba.load_userdict("data/zidian/user.dict")  # 准备分词词典
...
# 写了一个判断基于字典和句式的方法准确率的函数

def acc():
    num = 0
    with open("data/dict/dict_neg.txt","r",encoding="utf8") as file:
...
if __name__ == '__main__':
    ...
    d = DictClassifier()
    result = d.analysis_file(filepath_in="data/rengong/rengong_pos.txt",filepath_out="data/dict/dict_pos.txt")
    # # 计算准确率
    # acc()
